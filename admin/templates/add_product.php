...
<div class="content">
    ...
    <?php
    //echo         $category;
    echo ($_SESSION['add_product']['hits']);
    echo $_SESSION['add_product']['visible'];
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <table class="add_edit_page" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td><input class="head-text" type="text" name="price" value="<?php echo $_SESSION['add_product']['price'] ?>"/></td>
            </tr>
            <tr>
                <td class="add-edit-txt">Ключевые слова</td>
                <td><input class="head-text" type="text" name="keywords" value="<?php echo $_SESSION['add_product']['keywords'] ?>" /></td>
            </tr>
            <tr>
                <td class="add-edit-txt">Описание:</td>
                <td><input class="head-text" type="text" name="description" value="<?php echo $_SESSION['add_product']['description'] ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor1" class="anons-text" name="anons" value=""><?php echo ($_SESSION['add_product']['anons']) ?></textarea>
            ...
            <tr>
                <td colspan="2">
                    <textarea id="editor2" class="anons-text" name="content" value=""><?php echo ($_SESSION['add_product']['content']) ?></textarea>
                    <script type="text/javascript">
            ...
            <tr>
                <td>Отметить как:</td>
                <td><input type="checkbox" name="new" value="1" <?php if ($_SESSION['add_product']['new'] == 1) echo "checked"; ?>/> Новинка <br />
                    <input type="checkbox" name="hits" value="1" <?php if ($_SESSION['add_product']['hits'] == 1) echo "checked"; ?>/> Лидер продаж <br />
                    <input type="checkbox" name="sale" value="1"  <?php if ($_SESSION['add_product']['sale'] == 1) echo "checked"; ?>/> Распродажа <br /></td>
            </tr>
            </tr>
            <tr>
                <td>Показывать:</td>
